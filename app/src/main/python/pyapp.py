...
e4_ca_v, e4_mg_v, e4_k_v, e4_n_v, e4_p_v, e4_fe_v, e4_mn_v, e4_zn_v, e4_cu_v, e4_s_v, e4_b_v):
    ...
    'Ca':[0.0,0.0,0.0,0.0],
    'Mg':[0.0,0.0,0.0,0.0], #'Mg':[0.01,0.01,0.01,0.01],
    'K':[0.0,0.0,0.0,0.0],  #'K':[0.01,0.01,0.01,0.01],
    'P':[0.0,0.0,0.0,0.0],  #'P':[0.01,0.01,0.01,0.01],
    'N':[0.0,0.0,0.0,0.0],
    'Fe':[0.0,0.0,0.0,0.0],
    'Mn':[0.0,0.0,0.0,0.0],
    'Cu':[0.0,0.0,0.0,0.0],
    'Zn':[0.0,0.0,0.0,0.0],
    'OM':[0.0,0.0,0.0,0.0],
    'S':[0.0,0.0,0.0,0.0],  #'S':[0.01,0.01,0.01,0.01],
    'B':[0.0,0.0,0.0,0.0]
    }
    ...
    def main():
        ...
        for n_aplicacion in range(cantidad_aplicaciones):
            ...
            costo_CaCO3=round(costo_CaCO3,2)
